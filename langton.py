...
class Ant:
    ...
    def __init__(self, col, row, columns, rows):
        ...
        # the direction coordinate offsets; respectively: move west, north,
        # east, or south
...
class Grid(pyglet.window.Window):
    ...
    def draw_cell(self, col, row):
        ...
        x2, y2 = (col - 1) * self.cell_size + \
            self.cell_size, (row - 1) * self.cell_size + self.cell_size
    ...
    def draw_grid(self):
        ...
        for i in range(self.rows):
            pyglet.graphics.draw(2, pyglet.gl.GL_LINES, ('v2i', (0, i *
                                                                 self.cell_size, self.screen_width, i * self.cell_size)))
        # Vertical lines
        for j in range(self.columns):
            pyglet.graphics.draw(2, pyglet.gl.GL_LINES, ('v2i', (j *
                                                                 self.cell_size, 0, j * self.cell_size, self.screen_height)))
